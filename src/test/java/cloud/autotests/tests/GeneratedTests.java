...
public class GeneratedTests extends TestBase {
    ...
    @DisplayName("Проверка введенного слова")
    void generatedTest() {
        step("Открыть https://translate.yandex.ru/?lang=en-ru", () -> {
        ...
        step("Проверить что ввели слово broken", () -> {
            step("// todo: just add selenium action");
        });
    }
    ...
    void titleTest() {
        step("Open url 'https://translate.yandex.ru/?lang=en-ru'", () ->
            open("https://translate.yandex.ru/?lang=en-ru"));
